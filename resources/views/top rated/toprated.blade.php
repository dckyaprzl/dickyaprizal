...
<html lang="en">
  ...
  <style>
   ...
   .dropbtn {
    ...
    <title>MovieRecc | Top Rated</title>
...
<body>
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <div class="search-input">
                      <form id="search"  action="/toprated/cari" method="GET">
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="heading-section">
        <h4><em>Top Rated</em> Right Now</h4>
      </div>
     
                <a href="/toprated/tambahtop"> + Tambah Film Baru</a>
 ...
 <div class="card-container">
        ...
        <td><img src="{{ url ('/data_file/'.$p->thumbnail) }}"></td>
         <h3>{{ $p->Judul_Film }}</h3>
        ...
        <div class="actions">
          <a href="/toprated/edit/{{ $p->Kode_Film }}">Edit</a>
          |
          <a href="/toprated/hapus/{{ $p->Kode_Film }}">Hapus</a>
          |
          <a href="/toprated/detail/{{ $p->Kode_Film }}">Details>></a>
        </div>
